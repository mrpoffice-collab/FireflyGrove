        ...
        <div className="mb-8 flex items-center justify-between">
          ...
          <div className="flex gap-3">
            <Link
              ...
              className="px-6 py-3 bg-gradient-to-r from-green-500/20 to-green-600/20 hover:from-green-500/30 hover:to-green-600/30 border border-green-500 text-text-soft rounded-lg transition-soft"
            >
              🎯 Topic Intelligence
            </Link>
            <Link
              href="/marketing-genius/drafts"
              className="px-6 py-3 bg-gradient-to-r from-blue-500/20 to-blue-600/20 hover:from-blue-500/30 hover:to-blue-600/30 border border-blue-500 text-text-soft rounded-lg transition-soft"
            >
              📝 Draft Posts Review
            </Link>
            <Link
