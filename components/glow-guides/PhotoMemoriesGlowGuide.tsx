    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-bg-elevated border-2 border-firefly-glow rounded-xl max-w-lg w-full p-5 sm:p-8 shadow-2xl animate-fadeIn max-h-[90vh] overflow-y-auto">
        ...
        <div className="text-center mb-4 sm:mb-6">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl font-light text-firefly-glow mb-2">
            A Picture Holds a Thousand Stories
          </h2>
          <p className="text-text-muted text-xs sm:text-sm">Visual memories spark deeper recall</p>
        </div>
