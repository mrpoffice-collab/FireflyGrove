...
export default function GlowGuideAutoPopup() {
  ...
  // Page load trigger - DISABLED per user request
  // User wants popups to be less aggressive
  // useEffect(() => {
  ...
  // Idle trigger (30 seconds of no activity) - DISABLED per user request
  // User wants less aggressive popups
  // useEffect(() => {
  ...
  // Time on site trigger (2 minutes) - DISABLED per user request
  // User wants less aggressive popups
  // useEffect(() => {
  //   const timer = setTimeout(() => {
  ...
  // Random interval trigger (every 5-15 minutes) - DISABLED per user request
  // User wants less aggressive popups
  // useEffect(() => {
  ...
  // Scroll trigger (50% down page) - DISABLED per user request
  // User wants less aggressive popups
  // useEffect(() => {
  //   const handleScroll = () => {
  //     if (activeGuideSlug) return
  ...
  // Return visit trigger - DISABLED per user request
  // User wants less aggressive popups
  // useEffect(() => {
